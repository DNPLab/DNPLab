...
enhancements = dnp.integrate(enh_data, dim = 'f2', regions = [(0.0, 10.0)]) # integrate spectra
...
t1_integrals = dnp.integrate(t1_data, dim = 'f2', regions = [(0.0, 10.0)]) # integrate spectra
...
t10_integrals = dnp.integrate(t10_data, dim = 'f2', regions = [(0.0, 10.0)]) # integrate spectra
