...
########## OFF Signal (P = 0 W) ##########
data = dnp.dnpImport.load(
    "../data/prospa/10mM_TEMPO_Water/1Pulse_20200929/35/data.1d", data_type="prospa"
)
...
########## ON Signal (P = 2 W) ##########
data = dnp.dnpImport.load(
    "../data/prospa/10mM_TEMPO_Water/1Pulse_20200929/51/data.1d", data_type="prospa"
)
