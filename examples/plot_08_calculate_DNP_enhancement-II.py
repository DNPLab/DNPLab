...
This is a slightly more advanced example demonstrating how to ingegrate multiple regions of an NMR spectrum and calculate the DNP enhancement for two different regions.
"""
# %%
# Load NMR Spectra
# ----------------
