...
_numerical_types = (_np.ndarray, int, float, complex, _np.complex64, _np.float16, _np.double, _np.longdouble, _np.csingle, _np.cdouble, _np.clongdouble, _np.longlong)
