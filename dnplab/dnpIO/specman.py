...
def load_specman_values(path):
    ...
    if uint_read[2] == 1:
        ...
        y_data = np.reshape(float_data_folded, (uint_read[5], uint_read[4], uint_read[3]))
    elif uint_read[2] == 4:
        y_data = np.reshape(float_data_folded, (uint_read[6], uint_read[5], uint_read[4], uint_read[3]))
