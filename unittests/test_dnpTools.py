...
class dnpTools_tester(unittest.TestCase):
    ...
    def test_integrate(self):
        dnp.integrate(self.data, dim = "f2")

    def test_mr_properties(self):

        info_1H = dnp.constants.mr_properties("1H")
        self.assertEqual(info_1H, 26.7522128)

        info_1H = dnp.constants.mr_properties("1H", 0.35)
        self.assertEqual(info_1H, 14902114.17018196)

        info_2H = dnp.constants.mr_properties("2H", "qmom")
        self.assertEqual(info_2H, 0.286)

        info_6Li = dnp.constants.mr_properties("6Li", "natAbundance")
        self.assertEqual(info_6Li, 7.59)

        info_6Li = dnp.constants.mr_properties("6Li", "relSensitivity")
