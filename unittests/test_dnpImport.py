...
class import_topspin_tester(unittest.TestCase):
    ...
    def test_dir_data_type(self):
        ...
        self.assertEqual(
            "serPhaseCycle", topspin.dir_data_type(self.testdata, expNum=5)
        )
        self.assertEqual(
            "serPhaseCycle", topspin.dir_data_type(self.testdata, expNum=6)
        )
        self.assertEqual(
            "serPhaseCycle", topspin.dir_data_type(self.testdata, expNum=7)
        )
        self.assertEqual(
            "serPhaseCycle", topspin.dir_data_type(self.testdata, expNum=8)
        )
        self.assertEqual(
            "serPhaseCycle", topspin.dir_data_type(self.testdata, expNum=9)
        )
        self.assertEqual(
            "serPhaseCycle", topspin.dir_data_type(self.testdata, expNum=10)
        )
        self.assertEqual(
            "serPhaseCycle", topspin.dir_data_type(self.testdata, expNum=11)
        )
        self.assertEqual(
            "serPhaseCycle", topspin.dir_data_type(self.testdata, expNum=12)
        )
        self.assertEqual(
            "serPhaseCycle", topspin.dir_data_type(self.testdata, expNum=13)
        )
        self.assertEqual(
            "serPhaseCycle", topspin.dir_data_type(self.testdata, expNum=14)
        )
        self.assertEqual(
            "serPhaseCycle", topspin.dir_data_type(self.testdata, expNum=15)
        )
        self.assertEqual(
            "serPhaseCycle", topspin.dir_data_type(self.testdata, expNum=16)
        )
        self.assertEqual(
            "serPhaseCycle", topspin.dir_data_type(self.testdata, expNum=17)
        )
        self.assertEqual(
            "serPhaseCycle", topspin.dir_data_type(self.testdata, expNum=18)
        )
        self.assertEqual(
            "serPhaseCycle", topspin.dir_data_type(self.testdata, expNum=19)
        )
        self.assertEqual(
            "serPhaseCycle", topspin.dir_data_type(self.testdata, expNum=20)
        )
        self.assertEqual(
            "serPhaseCycle", topspin.dir_data_type(self.testdata, expNum=21)
        )
        self.assertEqual(
            "serPhaseCycle", topspin.dir_data_type(self.testdata, expNum=22)
        )
        self.assertEqual(
            "serPhaseCycle", topspin.dir_data_type(self.testdata, expNum=23)
        )
        self.assertEqual(
            "serPhaseCycle", topspin.dir_data_type(self.testdata, expNum=24)
        )
        self.assertEqual(
            "serPhaseCycle", topspin.dir_data_type(self.testdata, expNum=25)
        )
        self.assertEqual(
            "serPhaseCycle", topspin.dir_data_type(self.testdata, expNum=26)
        )
...
class prospa_import_tester(unittest.TestCase):
    ...
    def test_import_prospa_exp_is_1d(self):
        datas = [
            prospa.import_prospa(self.test_data + "/%i/data.csv" % expNum)
...
class vnmrj_import_tester(unittest.TestCase):
    def setUp(self):
        self.test_data2Ds = [
            "./data/vnmrj/" + s for s in ["10mM_tempol_in_water_array.fid"]
        ]
        self.test_data1Ds = [
            "./data/vnmrj/" + s
            for s in [
